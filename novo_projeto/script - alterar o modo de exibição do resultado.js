...
function manipulaDOM() {
    ...
    document.getElementById('resultado').innerHTML = `Saldo Salário R$: ${saldoSalario.toFixed(2)} + Férias Vencidas R$: ${feriasVencidas.toFixed(2)} +
    Férias Proporcionais R$: ${feriasProporcionais.toFixed(2)} + Décimo Terceiro Proporcional R$: ${decimoTerceiroProporcional.toFixed(2)} + 
    Aviso Prévio Indenizado R$: ${avisoPrevioIndenizado.toFixed(2)} + Multa Rescisória R$: ${multaRescisoria.toFixed(2)} =
